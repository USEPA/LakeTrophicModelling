...
```{r nlaMap, echo=FALSE, fig.cap="Map of the distribution of National Lakes Assesment Sampling locations\\label{fig:nlaMap}"}
...
```{r trophicStateTable, results='asis', echo=FALSE, tab.cap="Chlorophyll a based trophic state cut-offs\\label{tab:trophicStateTable}"}
...
```{r VarSel_Model1,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 1\\label{tab:VarSel_Model1}"}
kable(sumTable(all_ts4[1:100]),row.names=F)
```

```{r Confusion_Model1,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 1\\label{tab:Confusion_Model1}"}
...
```{r Importance_Model1,results="asis",echo=FALSE, fig.cap="Importance plot for Model 1\\label{fig:Importance_Model1}"}
...
```{r VarSel_Model2,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 2"}
kable(sumTable(all_ts3[1:100]),row.names=F)
```

```{r Confusion_Model2,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 2"}
kable(formatC(round(all_ts3_rf$confusion,2)),row.names=F)
```

```{r Importance_Model2,results="asis",echo=FALSE, fig.cap="Importance plot for Model 2"}
...
```{r VarSel_Model3,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 3"}
kable(sumTable(all_ts2[1:100]),row.names=F)
```

```{r Confusion_Model3,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 3"}
kable(formatC(round(all_ts2_rf$confusion,2)),row.names=F)
```

```{r Importance_Model3,results="asis",echo=FALSE, fig.cap="Importance plot for Model 3"}
...
```{r VarSel_Model4,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 4" }
kable(sumTable(gis_ts4[1:100]),row.names=F)
```

```{r Confusion_Model4,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 4" }
kable(formatC(round(gis_ts4_rf$confusion,2)),row.names=F)
```

```{r Importance_Model4,results="asis",echo=FALSE, tab.cap="Importance plot for Model 4"}
...
```{r VarSel_Model5,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 5"}
kable(sumTable(gis_ts3[1:100]),row.names=F)
```

```{r Conufsion_Model5,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 5"}
kable(formatC(round(gis_ts3_rf$confusion,2)),row.names=F)
```

```{r Importance_Model5,results="asis",echo=FALSE, fig.cap="Importance plot for Model 5"}
...
```{r VarSel_Model6,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 6"}
kable(sumTable(gis_ts2[1:100]),row.names=F)
```

```{r Confusion_Model6,results="asis",echo=FALSE, tab.cap="Random forest confusion matrix for Model 6"}
kable(formatC(round(gis_ts2_rf$confusion,2)),row.names=F)
```

```{r Importance_Model6,results="asis",echo=FALSE, fig.cap="Importance plot for Model 6"}
...
```{r ts_4_biov, echo=FALSE, fig.width=7, fig.cap="Cumulative distribution function of cyanobacetria biovolume for 4 trophic state classes"}
...
```
\newpage
```{r ts_3_biov_cdf, echo=FALSE, fig.width=7, fig.cap="Cumulative distribution function of cyanobacetria biovolume for 3 trophic state classes" }
...
```
\newpage
```{r ts_2_biov_cdf, echo=FALSE, fig.width=7, fig.cap="Cumulative distribution function of cyanobacetria biovolume for 2 trophic state classes"}
...
```
\newpage
```{r scatterplot,echo=FALSE, fig.width=7, fig.cap="Cholorphyll *a* and cyanobacteria biovolume scatterplot"}

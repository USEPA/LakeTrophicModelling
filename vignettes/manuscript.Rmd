...
```{r ecoregion_map, eval=TRUE, results="asis",echo=FALSE, fig.cap="Wadeable Sreams assesment ecoregions  \\label{fig:ecoregion_map}",cache=FALSE,fig.height=7,message=FALSE}

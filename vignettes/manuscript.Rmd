...
cmt_all<-table_to_df(round(all_ts4_conmat,2)) 
cmt_all$Class_Accuracy <- apply(cmt_all,1,sum)
for(i in 1:nrow(cmt_all)){
  cmt_all$Class_Accuracy[i]<-round((cmt_all[i,i]/cmt_all$Class_Accuracy[i])*100,2)
}

cmt_gis<-table_to_df(round(gis_ts4_conmat,2)) 
cmt_gis$Class_Accuracy <- apply(cmt_gis,1,sum)
for(i in 1:nrow(cmt_gis)){
  cmt_gis$Class_Accuracy[i]<-round((cmt_gis[i,i]/cmt_gis$Class_Accuracy[i])*100,2)
}
...
The model built with all predictors used `r nrow(all_dat)` total observations, had a mean squared error of `r round(all_rf$mse[5000],2)` and and R\textsuperscript{2} of `r round(all_rf$rsq[5000],2)`.  The accuracy of the four trophic states was `r round(all_ts4_total_acc,3)*100`%, the Kappa coefficient was `r round(all_ts4_kappa,2)` and class accuracy ranged from `r min(round(cmt_all$Class_Accuracy))` to `r max(round(cmt_all$Class_Accuracy))`% (Table \ref{tab:Confusion_All_4}).  The variable selection process identified a reduced model with 20 variables (Figure \ref{fig:all_varsel_figure}).  The six most important variables were turbidity, total phosphorus, total nitrogen, elevation, total organic carbon, and N:P ratio (Figures \ref{fig:All_Importance}).  The role that each played in predicting chlorophyll *a* varied (Figure \ref{fig:all_partial_dependence}). 
...
fig1<-nlaMap(state,lakes_dd,mycolor,cats=TRUE,catColor=cbPalette)
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig1.tiff",
       plot = fig1,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig1.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig1.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig1
...
fig2<-ecor_map(wsa9)
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig2.tiff",
       plot = fig2,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig2.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig2.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig2
...
fig4<-importancePlot(all_rf, data_def=data_def,type='acc',size=3)#,aes(colour=all_ts4_color))
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig4.tiff",
       plot = fig4,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig4.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig4.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig4
...
fig5_1 <- partial_plot(all_rf_turb_pd,
                       x="Turbidity (NTU)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig5_2 <- partial_plot(all_rf_ntl_pd,
                       x=expression(paste('Total Nitrogen',' (',mu,'g/L)')),
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig5_3 <- partial_plot(all_rf_ptl_pd,
                       x=expression(paste('Total Phosporus',' (',mu,'g/L)')),
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig5_4 <- partial_plot(all_rf_elev_pd,
                       x="Elevation (m)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig5_5 <- partial_plot(all_rf_toc_pd,
                       x="Total Organic Carbon (mg/L)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig5_6 <- partial_plot(all_rf_np_pd,
                       x="N:P Ratio",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
#Height maximum is 6.8 inches
tiff(filename = "ecosphere_final/hollisterES15-00703R_fig5.tiff",
       res = 450,
       width = 6.1,
       height = 6.8,
       units = "in")
fig5<-grid.arrange(fig5_1,fig5_2,fig5_3,fig5_4,fig5_5,fig5_6)
dev.off()
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig5.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig5.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
grid.draw(fig5)
...
fig6<-varsel_plot(gis_vs)
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig6.tiff",
       plot = fig6,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig6.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig6.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig6
...
fig7 <- importancePlot(gis_rf, data_def=data_def,type='acc',size=3)#,aes(colour=all_ts4_color))
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig7.tiff",
       plot = fig7,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig7.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig7.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig7
...
fig8_1 <- partial_plot(gis_rf_ecor_pd, x="Ecoregion", 
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig8_2 <- partial_plot(gis_rf_crops_pd, x="Cropland (%)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig8_3 <- partial_plot(gis_rf_elev_pd,x="Elevation (m)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig8_4 <- partial_plot(gis_rf_lat_pd,x="Latitude (m)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig8_5 <- partial_plot(gis_rf_conifer_pd,x="Conifer (%)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
fig8_6 <- partial_plot(gis_rf_mndepth_pd,x="Mean Lake Depth (m)",
                       y=expression(paste('Log10 Chl ', italic("a"),' (',mu,'g/L)')))
          
tiff(filename = "ecosphere_final/hollisterES15-00703R_fig8.tiff",
       res = 450,
       width = 6.1,
       height = 6.8,
       units = "in")
fig8<-grid.arrange(fig8_1,fig8_3,fig8_3,fig8_4,fig8_5,fig8_6)
dev.off()
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig8.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig8.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
grid.draw(fig8)
...
fig9<-prob_cdf_fig
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig9.tiff",
       plot = fig9,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig9.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig9.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig9
...
fig10<-cond_acc_fig
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig10.tiff",
       plot = fig10,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig10.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig10.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig10
...
tiff(filename = "ecosphere_final/hollisterES15-00703R_fig11.tiff",
       res = 450,
       width = 7.82,
       height = 6.8,
       units = "in")
...
dev.off()
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig11.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig11.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
ts_prob_map(state,lakes_dd,gis_rf_ts_prob)
...
fig12<-pred_prob_map(state,lakes_dd,gis_rf_ts_prob)
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig12.tiff",
       plot = fig12,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig12.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig12.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig12
...
fig13<-density_plot(gis_rf_ts_prob,xvar="max",x="Predicted Probability")
#Height maximum is 6.8 inches
ggsave(filename = "ecosphere_final/hollisterES15-00703R_fig13.tiff",
       plot = fig13,
       dpi = 450,
       #width = 6.1,
       height = 6.8,
       units = "in")
x<-autocrop("ecosphere_final/hollisterES15-00703R_fig13.tiff",border = 5, 
            outfile = "ecosphere_final/hollisterES15-00703R_fig13.tiff",
            width = 6.1,
            res = 450,
            compression = "lzw")
fig13

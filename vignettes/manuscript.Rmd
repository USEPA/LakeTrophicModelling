...
```{r all_partial_dependence, eval=TRUE, echo=FALSE, fig.cap="\"All Variables\" Partial dependence plots for the top 5 most important variables. \\label{fig:all_partial_dependence}",cache=TRUE,fig.height=10}
par(mfrow=c(3,2))
...
```{r gis_partial_dependenceeval=TRUE, echo=FALSE, fig.cap="\"GIS Only Variables\" Partial dependence plots for the top 5 most important variables. \\label{fig:gis_partial_dependence}",cache=TRUE,fig.height=10}
par(mfrow=c(3,2))

...
<!-- JEFF NEED TO FIGURE OUT HOW TO INCLUDE VARSEL PROB in the write up (perhaps "reduced model in order"), yank out varsel table, include varsel probs in figure -->

...
all_rf_turb_pd<-partial_dependence(all_rf,all_dat,"TURB",cutoff = 5L, ci=TRUE,
                                   parallel = TRUE)
all_rf_ntl_pd<-partial_dependence(all_rf,all_dat,"NTL",cutoff = 5L,ci=TRUE,
                   parallel = TRUE)
all_rf_ptl_pd<-partial_dependence(all_rf,all_dat,"PTL",cutoff = 5L,ci=TRUE,
                   parallel = TRUE)
all_rf_elev_pd<-partial_dependence(all_rf,all_dat,"ELEV_PT",cutoff = 5L,ci=TRUE,
                   parallel = TRUE)
all_rf_toc_pd<-partial_dependence(all_rf,all_dat,"TOC",cutoff = 5L,ci=TRUE,
                   parallel = TRUE)
...
gis_rf_ecor_pd<-partial_dependence(gis_rf,gis_dat,"WSA_ECO9",cutoff = 5L, ci=TRUE,
                                   parallel = TRUE)
gis_rf_crops_pd<-partial_dependence(gis_rf,gis_dat,"CropsPer_3000m",cutoff = 5L, 
                                    ci=TRUE, parallel = TRUE)
gis_rf_elev_pd<-partial_dependence(gis_rf,gis_dat,"ELEV_PT",cutoff = 5L, ci=TRUE,
                   parallel = TRUE)
gis_rf_lat_pd<-partial_dependence(gis_rf,gis_dat,"AlbersY",cutoff = 5L, ci=TRUE,
                   parallel = TRUE)
gis_rf_conifer_pd<-partial_dependence(gis_rf,gis_dat,"EvergreenPer_3000m",cutoff = 5L, 
                                      ci=TRUE, parallel = TRUE)

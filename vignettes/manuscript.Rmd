...
data_def <- read.csv("../inst/extdata/data.def.csv")
...
```{r predicted_prob_map,eval=TRUE, results="asis",echo=FALSE, fig.cap="Maps of prediction probabilities for the discrete, predicted chlorophyll \\textit{a} trophic state.  Shows spatial patterns of prediction uncertainty.  \\label{fig:predicted_prob_map}",cache=FALSE}

...
Our complete dataset includes data on `r dim(ltmData)[1]` lakes; however `r sum(is.na(ltmData$TS_CHLA_4))` lakes did not have chlorophyll *a* data. Thus, the base dataset for our modelling was on `r dim(ltmData[!is.na(ltmData$TS_CHLA_4),])[1]` lakes.  

...
Cyanobacteria should be closely related to trophic state as they make up a component of the cholorophyll concentration in a lake.  If these associations are strong enough we may be able to expand models such as those reported here to also predict probability of cyanobacteria blooms.  To test if trophic state may be used differntiate cyanobacterial biovolume we examine distribution of cyanobacteria biovolume for eash trophic state and we also explore linear associations between Chlorohyll *a* and biovolume.

...
```{r analysis , eval=FALSE, include=FALSE, echo=FALSE, cache=TRUE}
################################################################################
...
```{r summaryStats, echo=FALSE, cache=TRUE, warning=FALSE}
...
The reduced model for Model 1 included NPratio, NTL, PTL, TOC, TURB, Ecoregions, K, ORGION, DOC, and DEPTHMAX (Table \ref{tab:VarSel_Model1})
...
(Table \ref{tab:Confusion_Model2})
(Table \ref{tab:VarSel_Model2})
(Figure \ref{fig:Importance_Model2})
...
(Table \ref{tab:Confusion_Model3})
(Table \ref{tab:VarSel_Model3})
(Figure \ref{fig:Importance_Model3})
...
(Table \ref{tab:Confusion_Model4})
(Table \ref{tab:VarSel_Model4})
(Figure \ref{fig:Importance_Model4})
...
(Table \ref{tab:Confusion_Model5})
(Table \ref{tab:VarSel_Model5})
(Figure \ref{fig:Importance_Model5})
...
(Table \ref{tab:Confusion_Model6})
(Table \ref{tab:VarSel_Model6})
(Figure \ref{fig:Importance_Model6})

##Associating Trophic State and Cyanobacteria
Arm waving goes here.
(Figure \ref{fig:ts_4_biov_cdf})
(Figure \ref{fig:ts_3_biov_cdf})
(Figure \ref{fig:ts_2_biov_cdf})
...
```{r Importance_Model2,results="asis",echo=FALSE, fig.cap="Importance plot for Model 2\\label{fig:Importance_Model2}",cache=TRUE}
...
```{r Importance_Model3,results="asis",echo=FALSE, fig.cap="Importance plot for Model 3\\label{fig:Importance_Model3}",cache=TRUE}
...
```{r Importance_Model4,results="asis",echo=FALSE, tab.cap="Importance plot for Model 4\\label{fig:Importance_Model4}",cache=TRUE}
...
```{r Importance_Model5,results="asis",echo=FALSE, fig.cap="Importance plot for Model 5\\label{fig:Importance_Model5}",cache=TRUE}
...
```{r Importance_Model6,results="asis",echo=FALSE, fig.cap="Importance plot for Model 6\\label{fig:Importance_Model6}",cache=TRUE}
...
```{r ts_4_biov_cdf, echo=FALSE, fig.width=7, fig.cap="Cumulative distribution function of cyanobacetria biovolume for 4 trophic state classes\\label{fig:ts_4_biov_cdf}",cache=TRUE}
...
```{r ts_3_biov_cdf, echo=FALSE, fig.width=7, fig.cap="Cumulative distribution function of cyanobacetria biovolume for 3 trophic state classes\\label{fig:ts_3_biov_cdf}",cache=TRUE }
...
```{r ts_2_biov_cdf, echo=FALSE, fig.width=7, fig.cap="Cumulative distribution function of cyanobacetria biovolume for 2 trophic state classes\\label{fig:ts_2_biov_cdf}",cache=TRUE}
...
```{r scatterplot,echo=FALSE, fig.width=7, fig.cap="Cholorphyll *a* and cyanobacteria biovolume scatterplot\\label{fig:scatterplot}",cache=TRUE}
...
```{r VarSel_Model2,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 2\\label{tab:VarSel_Model2}",cache=TRUE}
kable(sumTable(all_ts3[1:100]),row.names=F)
```

\newpage

```{r Confusion_Model2,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 2\\label{tab:Confusion_Model2}",cache=TRUE}
kable(formatC(round(all_ts3_rf$confusion,2)),row.names=F)
```

\newpage

```{r VarSel_Model3,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 3\\label{tab:VarSel_Model3}",cache=TRUE}
kable(sumTable(all_ts2[1:100]),row.names=F)
```

\newpage

```{r Confusion_Model3,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 3\\label{tab:Confusion_Model3}",cache=TRUE}
kable(formatC(round(all_ts2_rf$confusion,2)),row.names=F)
```

\newpage

```{r VarSel_Model4,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 4\\label{tab:VarSel_Model4}",cache=TRUE }
kable(sumTable(gis_ts4[1:100]),row.names=F)
```

\newpage

```{r Confusion_Model4,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 4\\label{tab:Confusion_Model4}",cache=TRUE }
kable(formatC(round(gis_ts4_rf$confusion,2)),row.names=F)
```

\newpage

```{r VarSel_Model5,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 5\\label{tab:VarSel_Model5}",cache=TRUE}
kable(sumTable(gis_ts3[1:100]),row.names=F)
```

\newpage

```{r Conufsion_Model5,results="asis",echo=FALSE, tab.cap="Random Forest confusion matrix for Model 5\\label{tab:Confusion_Model5}",cache=TRUE}
kable(formatC(round(gis_ts3_rf$confusion,2)),row.names=F)
```

\newpage

```{r VarSel_Model6,results="asis",echo=FALSE, tab.cap="Variable selection results for Model 6\\label{tab:VarSel_Model6}",cache=TRUE}
kable(sumTable(gis_ts2[1:100]),row.names=F)
```

\newpage

```{r Confusion_Model6,results="asis",echo=FALSE, tab.cap="Random forest confusion matrix for Model 6\\label{tab:Confusion_Model6}",cache=TRUE}

...
#Model 2: GIS Only Variables
  ...
  gis_rf<-runRandomForest(ltmData[predictors_gis],log10(ltmData$CHLA), 
                              ntree=1000,importance=TRUE,proximity=TRUE)
  gis_cf_dat <- data.frame(ltmData[predictors_gis],LogCHLA=log10(ltmData$CHLA))
  gis_cf_dat <- gis_cf_dat[complete.cases(gis_cf_dat),]

...
```{r all_partial_dependence, eval=TRUE, echo=FALSE, fig.cap="\"All Variables\" Partial dependence plots for the top 5 most important variables. \\label{fig:all_partial_dependence}",cache=FALSE}
```
...
```{r gis_probability_map, eval=TRUE, results="asis",echo=FALSE, fig.cap="Maps of prediction probabilities for each of the four chlorophyll \\textit{a} trophic states  \\label{fig:gis_probability_map}",cache=FALSE}
state<-map_data('state')
lakes_alb<-data.frame(ltmData[["AlbersX"]],ltmData[["AlbersY"]],
                     ltmData[["NLA_ID"]])
p4s<-"+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=37.5 +lon_0=-96 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m +no_defs" 

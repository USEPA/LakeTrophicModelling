...
ts_4_brks <- c(min(log10(ltmData$CHLA),na.rm=T),log10(2),log10(7),log10(30),max(log10(ltmData$CHLA),na.rm=T))
ts_4_cats <- c("oligo","meso","eu","hyper")
ts_2_brks <- c(min(log10(ltmData$CHLA),na.rm=T),log10(7),max(log10(ltmData$CHLA),na.rm=T))
...
```{r}
#Figure out a way to get the predictions per tree so we can get votes pre lake
#which gives us probability a lake is of a given class.

...
model (Figure \ref{fig:prob_cdf}). Additionally, the Kappa coefficeint
...
a Kappa Coefficeint of \textasciitilde{}1. This represents 55\% of the
...
``substantial'' aggrement (Landis and Koch 1977). For the ``GIS only''
model this is seen with 22\% of the lakes FIX ME Lastly, as prediction

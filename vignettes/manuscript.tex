...
accuracy of the four trophic states was 68.7\%, the Kappa coefficient
was 0.57 and class accuracy ranged from 60 to 82\% (Table
\ref{tab:Confusion_All_4}). The variable selection process identified a
reduced model with 20 variables (Figure \ref{fig:all_varsel_figure}).
...
states were predicted with a total accuracy of 49\%, had a Kappa
coefficient of 0.29 and class accuracy ranged from 39 to 76\% (Table
\ref{tab:Confusion_GIS_4}). The variable selection process for this
model produced a reduced model with 15 variables (Figure
\ref{fig:gis_varsel_figure}). The six most important variables were
ecoregion, percent cropland, elevation, latitude, percent evergreen
forest, and mean lake depth (Figures \ref{fig:GIS_Importance} \&
...
model this is seen with 100\% of the lakes. Lastly, as prediction
...
\midrule
\endhead
All & 86 & 100 & 1080\tabularnewline
0.50 & 88 & 98 & 1063\tabularnewline
0.60 & 95 & 92 & 999\tabularnewline
0.70 & 100 & 81 & 870\tabularnewline
0.80 & 100 & 55 & 596\tabularnewline
...
\midrule
\endhead
All & 70 & 100 & 1138\tabularnewline
0.50 & 75 & 96 & 1091\tabularnewline
0.60 & 86 & 83 & 949\tabularnewline
0.70 & 100 & 57 & 651\tabularnewline
0.80 & 100 & 22 & 247\tabularnewline
